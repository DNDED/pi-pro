import { loadConfig, setProvider, setModel, setBaseUrl, setApiKey, getApiKey, type ProviderName, type PiProConfig } from "@pi/provider";
...
export function formatConfigDisplay(cfg: PiProConfig, apiKey: string | undefined): string {
  const lines: string[] = [];
